...
export class DeliveryReportsComponent implements OnInit {
  ...
  constructor(private _ordersServ: DeliveryExecutiveService, private _userService: UserService, private _sessionService: SessionService, private router: Router) { }
