...
export class UserReportsComponent implements OnInit {
  ...
  constructor(private _restaurantService: RestaurantService, private _userService: UserService, private router: Router,private _sessionService:SessionService) { }
  ngOnInit(): void {
